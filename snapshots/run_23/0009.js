...
let gui;
let entropySlider, resonanceSlider, gravitationalSlider, foldingSlider, bleedSlider, decaySlider;
let crystalToggle, entanglementToggle, symmetryToggle, gravityToggle, foldingToggle, bleedToggle, decayToggle;
...
function draw() {
  ...
  for (let a of particles) {
    ...
    // Entropic Decay: Recording history for trails
