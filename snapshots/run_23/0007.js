...
let gui;
let entropySlider, resonanceSlider, gravitationalSlider, foldingSlider;
let crystalToggle, entanglementToggle, symmetryToggle, gravityToggle, foldingToggle;
  ...
  for (let a of particles) {
    ...
    for (let b of particles) {
      ...
      if (d2 > 0 && d2 < rMax * rMax) {
        ...
        // Fractal Folding Force: Recurse spatial calculations into nested coordinates
