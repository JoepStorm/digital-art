...
function draw() {
  ...
  // Custom decay with crystallization, gravitational lensing, and harmonic ripples
...
class Agent {
  ...
  updateDirection() {
    ...
    // Iteration 19: Spacetime Distortion via Mouse Interaction
    // Agents are pulled into a cyclonic orbit if the mouse is nearby
  ...
  updatePosition() {
    ...
    // Local viscosity based on trail density
    if (pixels[index] > 100) {
        this.speed *= 0.98;
    } else {
    ...
    // Toxicity death at high densities
    ...
    // Occasional branching to maintain population
