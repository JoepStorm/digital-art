...
function draw() {
  ...
  // Custom decay with "crystallization" and Gravitational Lensing effect
  // We process back-to-front to create a subtle radial warp inward
  const cx = width / 2;
  const cy = height / 2;
  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      // Gravitational Lens: Occasionally pull pixel data towards center
