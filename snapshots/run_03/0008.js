...
class Agent {
  ...
  updateDirection() {
    ...
    // Physarum logic modified by a slight repulsion from trail-density peaks to encourage exploration
  ...
  updatePosition() {
    ...
    let h = (d * 0.4 + this.dir * 20 + frameCount * 0.2) % 255;
...
class Agents {
  ...
  update() {
    ...
    // Changed to splice from the end to avoid index shifts during iteration
