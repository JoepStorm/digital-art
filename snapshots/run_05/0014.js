...
class Agent {
  ...
  init() {
    ...
    this.isFused = false; // Iteration 14: Fusion state
  }
    ...
    if (px >= 0 && px < width && py >= 0 && py < height) {
      ...
      if (this.isShadow) {
          ...
          if (!this.isGhost) {
              ...
              // Stellar Nucleosynthesis Iteration 14: Check for fusion-level intensity
              if (b > 240 && g > 180 && !this.isFused && random() < 0.05) {
                this.isFused = true;
                this.mutation *= 1.5;
                this.speed *= 0.5; // Burning core slows down
              }
              ...
              this.life -= this.isFused ? timeWarp * 2.5 : timeWarp;
          ...
          if (this.isRadiant) {
              ...
              // Iteration 14: Hot neon fusion trail
              pixels[index] = min(255, r + 250); // Intense Red
              pixels[index + 1] = min(255, g + 80); 
              pixels[index + 2] = min(255, b + 250); // Intense Violet/Pink
