...
class Agent {
  ...
  updatePosition() {
    ...
    if (px >= 0 && px < width && py >= 0 && py < height) {
      ...
      if (!this.isGhost) {
          // TEMPORAL DILATION: Aging is accelerated by environmental density (Blue/Green levels)
          // High density regions "cook" the agents faster, forcing rapid evolution or death
