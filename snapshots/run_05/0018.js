...
class Agent {
  ...
  init() {
    ...
    this.echoFactor = random(0.01, 0.05); // Chance to fracture per step
  }
  ...
  updateDirection() {
    ...
    // Iteration 18: Entropic Drift - Sudden fractures in path creating visual glitch/static
    ...
    if (px >= 0 && px < width && py >= 0 && py < height) {
      ...
      if (this.isShadow) {
          ...
          if (this.synapticPulse > 10) {
              ...
              // Iteration 18: Entropic coloration - older paths lean towards warmer, noisy hues
