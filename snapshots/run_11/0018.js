...
class Boid {
  constructor() {
    ...
    this.echoes = []; // Iteration 18: Storage for ghostly imprints
  }
  ...
  update() {
    ...
    // Iteration 18: Occasional ghost echo placement
    if (frameCount % 12 === 0) {
...
class Flock {
  ...
  draw() {
    ...
    this.boids.forEach(b => {
      ...
      // Iteration 18: Render ghostly echoes as translucent geometric imprints
      b.echoes.forEach(e => {
        push();
