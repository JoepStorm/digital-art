    ...
    for (let o of boids) {
      ...
      if (o !== this && d < perception) {
        if (o.species === this.species) {
          ...
          // Stellar Cartographer: Harmonic resonance links
...
class Flock {
  ...
  draw() {
    ...
    this.boids.forEach(b => {
      ...
      // Vitreous Glassblower effect: Translucent refracting "glass shards"
      // These appear behind fast-moving boids, capturing light in geometric volumes
