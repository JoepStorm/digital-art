    ...
    for (let o of boids) {
      ...
      if (o !== this && d < perception) {
        if (o.species === this.species) {
          ...
          // Stellar Cartographer: Draw evanescent connections between species-aligned neighbors
          // Connections only appear when pulses are nearly synchronized (harmonic resonance)
