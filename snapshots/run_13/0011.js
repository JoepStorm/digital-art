...
// Base rules that will be modulated dynamically
let rules = [
  [0, 0.19, 0.31, 1],
  [0, 0.48, 0.82, 0.2],
  [1, 0.23, 0.38, 0.9],
...
function step() {
  ...
  // Metamorphic rule drift: rules themselves mutate over time
  ...
  for (let y = 0; y < rows; y++) {
    for (let x = 0; x < cols; x++) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        // Apply metamorphosis to rule thresholds dynamically
