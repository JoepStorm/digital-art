...
function draw() {
  ...
  for (let y = 0; y < rows; y++) {
    for (let x = 0; x < cols; x++) {
      ...
      // Spectral Alchemist: Chromatic Refraction based on local field gradients
      // We calculate a pseudo-refractive index based on the values of horizontal and vertical neighbors
      ...
      // Refraction shifts the color phase locally for a "glassy" chromatic aberration effect
