...
class Agent {
  ...
  updateDirection() {
    ...
    if (this.type === 1) {
      ...
      // Instead of just fleeing, they spiral when predator heat (red/orange) is detected
  ...
  sense(dirOffset) {
    ...
    // Sensitivity to trail luminance, specific channels trigger different behaviors
  ...
  updatePosition() {
    ...
    const speed = (this.type === 1 ? 2.0 : 1.4) * speedBoost;
...
class Agents {
  ...
  update() {
    ...
    if (predatorCount > agentsNum * 0.5) {
