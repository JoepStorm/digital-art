...
function draw() {
  ...
  // Temporal Caustics: Use a sine-modulated copy function to create refracting wave patterns 
  // that warp the canvas based on a rhythmic oscillation, simulating light passing through moving fluid.
  if (frameCount % 3 === 0) {
