...
function draw() {
  // Oscillate the sensor range over time to create a rhythmic "breathing" effect in the simulation patterns
...
class Agent {
  ...
  sense(dirOffset) {
    ...
    // Return sum of RGB to detect any activity
  ...
  updatePosition() {
    ...
    const speed = (this.type === 1 ? 1.5 : 1.1) * speedBoost;
