...
function draw() {
  ...
  // Looming Entanglement: Spatially warp the canvas using a pixel offset map derived from recent trail density
  // This creates a sense of the fabric of the simulation bending under the weight of the populations
  if (frameCount % 2 === 0) {
