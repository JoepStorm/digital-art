...
function draw() {
  ...
  // Glitch Weaving: Tears in the grid based on local intensity
  let cell = 60;
  for (let y = 0; y < height; y += cell) {
    for (let x = 0; x < width; x += cell) {
      ...
      if (brightness < 180) {
         // Determine shift based on order vs chaos oscillation
         ...
         // Chromatic separation at high-density nodes
...
class Agent {
  ...
  updatePosition() {
    ...
    // Deepening the blue palette while allowing dark glitches
