...
function draw() {
  ...
  // Seed a new chaos eddy if mouse is pressed, acting as an 'Entropy Oracle'
  if (mouseIsPressed) {
  ...
  // Glitch Weaving & Prism Cathedral
  let cell = 60;
  ...
  // Decay chaos eddies and draw them to scaffold as entropy 'scars'
...
class Agent {
  ...
  updateDirection(timeCycle) {
    ...
    // Chaos Eddies influence: swirling zones that override grid order
