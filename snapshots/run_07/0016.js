...
class Agent {
  ...
  updateDirection(timeCycle) {
    ...
    // Tectonic Stress: A global gravity pull that acts on the structure, compressing vertical space
    let stressLines = abs(sin(this.y * 0.015 + frameCount * 0.005));
    if (stressLines > 0.95) {
       this.dir = lerp(this.dir, 0, 0.4); // Snap to horizontal "strata"
       this.speed *= 1.8;
    }
  ...
  updatePosition() {
    ...
    // Scaffolding lines are drawn more heavily in high horizontal stress areas
