...
class Agent {
  ...
  updateDirection() {
    ...
    if (distToMouse < chaosRadius) {
      ...
      // The Fractal Weaver: Modulating the grid strength with a nesting sin function to create "Lace-Work" pockets
      ...
      if (gridStrength > 0.55) {
        // Agents are forced into orthogonal structures in "Ordered" zones
        let targetDir = round(this.dir / HALF_PI) * HALF_PI;
        this.dir = lerp(this.dir, targetDir, 0.35); 
      } else {
  ...
  updatePosition() {
    ...
    // Glassy ink: deep indigo and slate tones 
