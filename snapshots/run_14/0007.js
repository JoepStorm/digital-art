...
function step() {
  ...
  for (let y = 0; y < rows; y++) {
    ...
    for (let x = 0; x < cols; x++) {
      ...
      // Calculate local density using the largest ring for transmutation check
      ...
      // Transmutation Rule: High density causes cells to cycle their type (A->B->C->A)
      // This creates "bubbling" regions where colors shift dynamically at active boundaries
