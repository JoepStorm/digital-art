...
class Agent {
  ...
  updateDirection() {
    ...
    // OSCILLATORY SIGNAL FLUCTUATIONS: Modulate sensor sensitivity over time
    // This creates a rhythmic "breathing" effect where agents alternate between following and exploring.
