  ...
  for (let y = height - 1; y >= 0; y--) {
    for (let x = 0; x < width; x++) {
      ...
      if (brightness < 255) {
        ...
        // Blue decays (returns to white) faster than red, creating a warm, amber-like ghosting on old edges.
...
class Agent {
  ...
  sense(dirOffset, sDist) {
    ...
    // Sensing luminosity primarily via the red channel for "warmth" bias
    return pixels[index];
  }
