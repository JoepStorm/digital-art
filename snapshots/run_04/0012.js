...
function draw() {
  ...
  // This causes patterns to periodically expand (blur) and then sharpen (harden)
  ...
  for (let i = 0; i < pixels.length; i += 4) {
    ...
    if (brightness < 255) {
      // Decay rate is now influenced by the global metabolism wave
...
class Agent {
  ...
  updateDirection() {
    ...
    // Agents used to prefer dark spots. Now if the center is TOO dark, they are repelled.
