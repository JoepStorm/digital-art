  ...
  for (let i = 0; i < particles.length; i++) {
    ...
    for (let j = 0; j < particles.length; j++) {
      ...
      if (d2 < rMax * rMax) {
        ...
        // Iteration 8 change: Spatial Warping
        // Particles now feel a subtle "rift" force towards the center-lines of the screen, creating organic flow paths
