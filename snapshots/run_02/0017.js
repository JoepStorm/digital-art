...
class Agent {
  ...
  updatePosition() {
    ...
    // High-energy regions warp space-time for the agents, pulling them into swirls
    ...
    bloomGrid[npx + npy * width] += 65 * this.energy;
  }
}
...
class Agents {
  ...
  update() {
    let spawnQueue = [];
    // Only a subset interact per frame for performance balance
