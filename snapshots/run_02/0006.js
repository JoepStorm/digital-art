...
class Agent {
  ...
  updatePosition() {
    // Kinetic Effect: Trail intensity creates a local velocity field that influences speed
    // Higher "scent" density slightly accelerates or decelerates agents based on their species logic
