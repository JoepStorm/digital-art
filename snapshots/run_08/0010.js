...
class Agent {
  ...
  updatePosition(others) {
    ...
    // METAL PLATING (LAMELAR BRIDGING): If agents intersect central axes, they deposit high-intensity
    // structural nodes, creating a "plated" look to reinforced parts of the microorganism web.
    if (abs(this.x - width/2) < 2 || abs(this.y - height/2) < 2) {
