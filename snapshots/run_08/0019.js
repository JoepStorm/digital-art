...
function draw() {
  ...
  // THE CYTOSKELETIST & MYOFIBRIL-ARCHITECT: 
  // Generation of thick striated protein bundles between the center and nodes to reinforce structural integrity
  if(frameCount % 45 === 0) {
    ...
    for(let j = 0; j < 5; j++) {
      ...
      for(let t = 0; t <= 1; t += 1/steps) {
        // Create wavy, fibrous bundles resembling muscle or cytoskeletal fibers
  ...
  updatePosition(others) {
    ...
    if (random() < 0.08) {
      ...
      if (d2 < 3000 && d2 > 16) { 
        ...
        // THE NEURO-ARCHITECT: Sparse, long-range synaptic dendrites reaching towards distant hubs
