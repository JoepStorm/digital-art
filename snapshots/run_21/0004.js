...
let decoherenceMode = true; // Toggle for the user: shifts colors based on local kinetic energy
...
function draw() {
  ...
  for (let p of particles) {
    ...
    // Chromatic Decoherence: Kinetic energy shifts the particle towards higher energy states (white/blue)
    if (decoherenceMode) {
