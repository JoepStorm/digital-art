...
let stringsMode = true; // New string theory-inspired vibration mode
...
function draw() {
  ...
  for (let p of particles) {
    ...
    // Strings Mode: High-frequency spatial jitter representing vibrational harmonics
    if (stringsMode) {
